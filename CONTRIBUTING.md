...
[knowledge hub Knowledge Hub](https://github.com/knowledge hub-one/Knowledge-Hub) is [MIT](LICENSE) licensed and accepts contributions via GitHub pull requests. This document outlines some of the conventions on development workflow, commit message formatting, contact points and other resources to make it easier to get your contribution accepted.
...
- We prefer blog on topic of blockchain and if we like your blog we will publish it to our official website [knowledge hub.one](https://knowledge hub.one) and give the credit to you.
